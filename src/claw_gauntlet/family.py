...
_MANIFESTS = (
    _manifest("StarClaw", "discovery", ("github.stars.watch",)),
    _manifest("GHClaw", "discovery", ("github.repo.collect",)),
    _manifest("HNClaw", "discovery", ("hn.research",)),
    _manifest("RSSClaw", "discovery", ("feed.collect",)),
    _manifest("ProjectClaw", "intelligence", ("evidence.evaluate",)),
    _manifest("TrustClaw", "intelligence", ("provenance.verify",)),
    _manifest("RRSClaw", "intelligence", ("run.score", "run.regression")),
