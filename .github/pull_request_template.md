...
<!-- Include commands and results. Link evidence by public-safe reference. -->

## Permissions and data

<!-- List new network, credential, storage, communication, or publishing boundaries. Write "None" when unchanged. -->
...
- [ ] This change does not autonomously post, message, vote, solicit engagement, or contact people.
- [ ] Manifest status and capability documentation match what actually works.
